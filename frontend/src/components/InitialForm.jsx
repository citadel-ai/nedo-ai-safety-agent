    ...
    <div className="h-full flex flex-col">
      ...
      <div className="px-1 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Japan Helpdesk</h1>
      ...
      <div className="flex-1 overflow-y-auto px-1">
        <div className="max-w-2xl mx-auto">
          {/* Explanation Card */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 mt-3">
            <div className="flex items-start gap-3">
              <div className="text-2xl">ℹ️</div>
              <div>
                <h3 className="font-semibold text-blue-900 mb-1">Before we start</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="font-medium mb-1">Single Turn</div>
                ...
                >
                  <div className="font-medium mb-1">Multi Turn</div>
