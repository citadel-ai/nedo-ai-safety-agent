...
async def ingest_documents(document_paths: List[str], category: str = "user_docs") -> None:
    ...
    if all_documents:
        ...
        logger.info(f"Vector database now contains {info.get('document_count', 0)} total documents")
    else:
        logger.warning("No documents were processed")

def main():
    parser = argparse.ArgumentParser(description="Ingest documents into Japan Helpdesk vector database")
    parser.add_argument(
        "documents", 
        nargs="+", 
