...
A live demo is temporarily available at **https://test.ai-safety-agent.com/** (expected to remain online for a limited period of a couple of months).
...
ライブデモは **https://test.ai-safety-agent.com/** で一時的に公開されています（数ヶ月間の限定公開予定）。
