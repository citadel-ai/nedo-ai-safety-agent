...
Exposes REST endpoints for setting user context, querying the LangGraph agent,
submitting feedback, and serving the React frontend build.
"""
...
from ..services.query import get_thread_state, query_agent, remove_collected_fact, submit_feedback
from ..utils.config import Config
from ..utils.langfuse_config import flush_langfuse, initialize_langfuse
...
@limiter.limit(Config.RATE_LIMIT_CONTEXT)
async def set_context(request: Request, context: UserContextRequest):
    """
...
async def query(request: Request, body: QueryRequest):
    ...
    Args:
        body: QueryRequest with question, thread_id, and optional conversation_mode
