...
from ..utils.citation_extractor import extract_citations_from_raw_response, extract_inline_citation_numbers
...
def search_and_respond(state: AgentState) -> AgentState:
    ...
    try:
        ...
        if hasattr(raw_response, 'summary') and raw_response.summary:
            summary_text = raw_response.summary.summary_with_metadata.summary # summary_text will have [1] inline citations
